...
const parsePathParamsPattern = (url, pathParamsPattern) => {
    ...
    if (maybeDiff) {
        return {
            error: {
                message: `Path parameters do not align with the URL path: /${maybeDiff}`,
            },
        };
    }
    ...
    if (invalidParameterSegments.length > 0) {
        return {
            error: {
                message: `The path parameter name '${invalidParameterSegments[0]}' is not` +
...
//# sourceMappingURL=path-params-parser.js.map